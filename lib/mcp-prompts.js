...
Always runs build-time lint (config, CSS classes, structure). When the preview server is running, also includes runtime errors (same errors shown in the debug panel Errors tab).

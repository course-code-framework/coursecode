import{g as t,h as n}from"./index-D8AaJkY8.js";async function o(){t({correct:!0,score:1,topic:"introduction",difficulty:1,attempts:1},[]),await n()}const l={render:i=>{const e=document.createElement("div");return e.innerHTML=`
    ...
    `,e.querySelector("#complete-intro-btn").addEventListener("click",o),e}};export{l as slide};
